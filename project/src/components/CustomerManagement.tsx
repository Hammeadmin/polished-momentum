                ...
                <tr>
                  <td colSpan={4} className="text-center p-12">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-sm text-gray-500">Laddar kunder...</p>
                    </div>
                  </td>
                </tr>
              ) : customers.length === 0 ? (
                <tr>
                  <td colSpan={4} className="text-center p-12">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-gray-600 font-medium">Inga kunder hittades</p>
                      <p className="text-sm text-gray-500 mt-1">Börja med att lägga till din första kund</p>
                    </div>
                  </td>
                </tr>
              ) : (

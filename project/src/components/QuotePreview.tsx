...
const EditableElement = ({
  ...
  return (
    <Tag
      className={`${className} hover:bg-blue-50 hover:outline-dashed hover:outline-1 hover:outline-blue-300 rounded px-1 -mx-1 transition-colors cursor-text focus:bg-white focus:outline-blue-500 focus:ring-2 focus:ring-blue-200`}
...
const DraggableBlockWrapper = ({
  ...
  return (
    <div
      ...
      className="relative mb-4 rounded-lg border-2 border-dashed border-transparent hover:border-blue-300 bg-white transition-all"
    >
      ...
      <div className="absolute -top-3 right-2 flex items-center gap-1 bg-white shadow-sm border border-gray-200 rounded-md px-1 py-0.5 z-20">
        <div className="p-1 text-gray-400 cursor-move hover:text-blue-600" title="Dra för att flytta">
...
function QuotePreview({
  ...
  const designOptions = template?.settings?.design_options || template?.design_options || {};
  const {
    font_family = 'Inter',
  ...
  const renderContentBlock = (block: ContentBlock, index: number) => {
    ...
    switch (block.type) {
      ...
      case 'payment_info':
        ...
        innerContent = (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 my-6" style={paymentStyles}>
            <h3 className="font-bold text-blue-800 mb-4 text-lg">Betalningsinformation</h3>
  ...
  return (
    <div className={`bg-white border border-gray-200 shadow-lg max-w-4xl mx-auto min-h-[800px] relative print:shadow-none print:border-0 print:max-w-none ${isEditable ? 'ring-offset-2 ring-2 ring-blue-100' : ''}`} style={{ fontFamily: font_family }}>
      ...
      <div className="p-8 print:p-0 print:px-[15mm] print:py-[10mm]">
        ...
        {/* Render ALL blocks from content_structure */}

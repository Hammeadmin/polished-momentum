      ...
      <div className="flex items-center justify-between h-16 px-4 lg:px-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="hidden sm:flex items-center space-x-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded-xl hover:bg-gradient-to-r hover:from-blue-500/10 hover:to-indigo-500/10 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-300 border border-transparent transition-all duration-300 min-w-64 group"
          >
            <Search className="w-4 h-4 group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300" />
            <span className="text-sm group-hover:font-medium transition-all">Sök...</span>
            <div className="ml-auto flex items-center space-x-1">
              <kbd className="px-2 py-1 text-xs bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded shadow-sm group-hover:border-blue-300 group-hover:shadow-blue-100 transition-all duration-300">
          ...
          <div className="relative">
            <button
              ...
              className={`p-2 rounded-lg transition-all duration-300 relative group ${showNotifications
                  ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400'
                  : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:scale-105'
                }`}
              title="Notifieringar"
            >
              <Bell className={`w-5 h-5 transition-transform duration-300 ${showNotifications ? 'animate-none' : 'group-hover:rotate-12'}`} />
              {unreadCount > 0 && (
                <div className="absolute -top-1 -right-1 min-w-5 h-5 px-1 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-lg shadow-red-500/30 animate-bounce-subtle">
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center space-x-2 p-2 rounded-lg transition-colors duration-200 ${showUserMenu
